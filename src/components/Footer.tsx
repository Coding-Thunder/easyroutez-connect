      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
          ...
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-blue-900">FlightBizz</h2>
          </div>

          {/* Contact Information */}
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <a
              href="mailto:support@flightbizz.com"
              className="flex items-center gap-2 text-gray-700 hover:text-blue-600 transition-colors"
            >
              <Mail className="w-5 h-5 text-blue-600" />
              <span className="font-medium">support@flightbizz.com</span>
            </a>
        ...
        <div className="border-t border-gray-200 mt-6 pt-4 text-sm text-gray-500 text-center">
          © 2025 <span className="font-semibold text-blue-900">FlightBizz</span>
          . All Rights Reserved.
        </div>
      </div>
    </footer>
