...
const CallButton = ({
  ...
  const baseClasses =
    "font-semibold transition-all duration-300 hover:shadow-medium";
  ...
  const variants = {
    ...
    header:
      "bg-primary text-primary-foreground hover:bg-primary-dark border border-primary",
  };
  ...
  return (
    ...
    >
      <a href="tel:+18557616979" className="inline-flex items-center">
        ...
        {variant === "secondary" ? "Call Now" : "1-855-761-6979"}
      </a>
    </Button>
  );
};
